            ...
                    <div class="card-body p-4 position-relative">
                            <div class="row align-items-center">
                                    <div class="col-md-8">
                        ...
                                            <p class="mb-0 opacity-75">Selamat datang di Dashboard Administrator. Pantau
                ...
                            <div class="card border-0 shadow-sm bg-success text-white h-100 overflow-hidden">
                                    <div
                        ...
                                            <a href="{{ route('admin.keuangan.index') }}"
                            ...
                                                </a>
                                            <i class="fas fa-chart-line fa-4x position-absolute opacity-25"
            ...
                    <div class="col-lg-8 mb-4">
                            <div class="card border-0 shadow rounded-3 h-100">
                                    <div
                        ...
                                            <h6 class="fw-bold text-primary m-0"><i class="fas fa-history me-2"></i> Surat
                            Masuk Terbaru</h6>
                   
                                    ...
                                                                    @empty
                                                                        <tr>
                                                                                <td colspan="4"
                                                ...
                                                                                        <p class="mb-0 small">Belum ada surat
                                                    masuk.</p>
                                                                                    </td>
                                                                            </tr>
                                                                    @endforelse
...
           
                            <div class="card border-0 shadow-sm mb-4">
                                    <div class="card-header bg-white py-3 border-bottom-0">
                                            <h6 class="fw-bold text-dark m-0"><i class="fas fa-chart-pie me-2"></i>
                ...
                            <div class="card border-0 shadow rounded-3">
                                    <div class="card-header bg-white py-3 border-bottom-0">
                                            <h6 class="fw-bold text-danger m-0"><i class="fas fa-bullhorn me-2"></i> Aduan
                            Terbaru</h6>
                                        </div>
                                    <div class="card-body p-0">
                            ...
                                                    @forelse($riwayatAduan as $aduan)
                                                        <li class="list-group-item p-3 border-bottom-0 border-top">
                                                                <div class="d-flex justify-content-between align-items-start">
                                                                        <div>
                                                                                <h6 class="mb-1 fw-bold text-dark small">
